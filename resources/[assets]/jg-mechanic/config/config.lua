    ...
    shops = {
      {
        ...
        items = {
          ...
          { name = "cleaning_kit", label = "Cleaning Kit", price = 500 },
          { name = "repair_kit", label = "Repair Kit", price = 2000 },
          { name = "duct_tape", label = "Duct Tape", price = 100 },
        },
      },
      {
        ...
        items = {
          ...
          { name = "i4_engine", label = "I4 Engine", price = 15000 },
          { name = "v6_engine", label = "V6 Engine", price = 25000 },
          { name = "v12_engine", label = "V12 Engine", price = 50000 },
          { name = "ev_motor", label = "EV Motor", price = 35000 },
          { name = "ev_battery", label = "EV Battery", price = 30000 },
          { name = "ev_coolant", label = "EV Coolant", price = 2000 },
          { name = "awd_drivetrain", label = "AWD Drivetrain", price = 20000 },
          { name = "rwd_drivetrain", label = "RWD Drivetrain", price = 20000 },
          { name = "fwd_drivetrain", label = "FWD Drivetrain", price = 20000 },
          { name = "slick_tyres", label = "Slick Tyres", price = 5000 },
          { name = "semi_slick_tyres", label = "Semi Slick Tyres", price = 4000 },
          { name = "offroad_tyres", label = "Offroad Tyres", price = 3500 },
          { name = "drift_tuning_kit", label = "Drift Tuning Kit", price = 30000 },
          { name = "manual_gearbox", label = "Manual Gearbox", price = 15000 },
        },
      },
      {
        ...
        marker = { id = 21, size = { x = 0.3, y = 0.3, z = 0.3 }, color = { r = 255, g = 255, b = 255, a = 120 }, bobUpAndDown = 0, faceCamera = 0, rotate = 1, drawOnEnts = 0 },
        items = {
          { name = "lighting_controller", label = "Lighting Controller", price = 5000 },
          { name = "stancing_kit", label = "Stancer Kit", price = 8000 },
          { name = "cosmetic_part", label = "Cosmetic Parts", price = 3000 },
          { name = "respray_kit", label = "Respray Kit", price = 10000 },
          { name = "vehicle_wheels", label = "Vehicle Wheels Set", price = 5000 },
          { name = "tyre_smoke_kit", label = "Tyre Smoke Kit", price = 4000 },
          { name = "bulletproof_tyres", label = "Bulletproof Tyres", price = 15000 },
          { name = "extras_kit", label = "Extras Kit", price = 2000 },
          { name = "nitrous_bottle", label = "Nitrous Bottle", price = 20000 },
          { name = "empty_nitrous_bottle", label = "Empty Nitrous Bottle", price = 5000 },
          { name = "nitrous_install_kit", label = "Nitrous Install Kit", price = 10000 },
          { name = "performance_part", label = "Performance Parts", price = 12000 },
        },
      }
    },
    stashes = {
