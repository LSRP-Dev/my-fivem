return {
    ...
    ['cardboard'] = {
        ...
        consume = 0,
        client = {
            image = 'blackmarket-password.png',
    ...
    ['cardboard-location'] = {
        ...
        consume = 0,
        client = {
            image = 'blackmarket-location.png',
            event = 'cardboard:read'
        },
    },
...
['tablet'] = {
    ...
    ['bs_heartstopper'] = {
        ...
        stack = true,
        close = true,
        client = { image = 'bs_heartstopper.png' }
    },
    ['bs_heartstopper_meal'] = {
        ...
        stack = true,
        close = true,
        client = { image = 'bs_heartstopper_meal.png' }
    },
    ['bs_moneyshot'] = {
        label = 'Bs Moneyshot',
        description = '',
    ...
    ['bs_moneyshot_meal'] = {
        ...
        stack = true,
        close = true,
        client = { image = 'bs_moneyshot_meal.png' }
    },
    ['bs_nuggets'] = {
        label = 'Bs Nuggets',
        description = '',
    ...
    ['bs_nugget_meal'] = {
        ...
        stack = true,
        close = true,
        client = { image = 'bs_nugget_meal.png' }
    },
    ['bs_torpedo'] = {
        label = 'Bs Torpedo',
        description = '',
    ...
    ['bs_torpedo_meal'] = {
        ...
        stack = true,
        close = true,
        client = { image = 'bs_torpedo_meal.png' }
    },
    ['burger_bun'] = {
        label = 'Burger Bun',
        description = '',
    ...
    ['burger_cheese'] = {
        ...
        stack = true,
        close = true,
        client = { image = 'burger_cheese.png' }
    },
    ['burger_meat'] = {
        label = 'Burger Meat',
        description = '',
    ...
    ['cooked_chicken_burger'] = {
        ...
        stack = true,
        close = true,
        client = { image = 'cooked_chicken_burger.png' }
    },
    ['cooking_oil'] = {
        label = 'Cooking Oil',
        description = '',
    ...
    ['frozen_nuggets'] = {
        ...
        stack = true,
        close = true,
        client = { image = 'frozen_nuggets.png' }
    },
    ['lettuce'] = {
        label = 'Lettuce',
        description = '',
