...
Config.market_categories = {
	...
	['vape_market'] = {
		['page_name'] = "Vapes",
		['page_desc'] = "Discover our premium selection of vapes and vape juices, from refillable kits to disposable options, available in a variety of flavors to suit your preference",
		['page_icon'] = '<img src="img/categories/drinks-icon.png" style="padding:15px">',
		['page_img'] = 'img/categories/drinks.png',
		['category_buy_price'] = 4000,
		['category_sell_price'] = 2000,
		['items'] = {
			['vape'] = {
				['name'] = "Vape Kit",
				['price_to_customer'] = 150,
			...
			['vape_refill_strawberry'] = {
				...
				['img'] = 'vape_refill_strawberry.png',
			},
			['vape_refill_reallyberry'] = {
				['name'] = "Really Berry Vape Juice",
				['price_to_customer'] = 25,
				['price_to_customer_min'] = 12,
				['price_to_customer_max'] = 50,
				['price_to_export'] = 22,
				...
				['amount_to_owner'] = 20,
				['amount_to_delivery'] = 20,
				['img'] = 'vape_refill_reallyberry.png',
			},
			['vape_refill_coconutlimeade'] = {
				['name'] = "Coconut Limeade Vape Juice",
				['price_to_customer'] = 25,
				['price_to_customer_min'] = 12,
				['price_to_customer_max'] = 50,
				['price_to_export'] = 22,
				...
				['amount_to_owner'] = 20,
				['amount_to_delivery'] = 20,
				['img'] = 'vape_refill_coconutlimeade.png',
			},
			['vape_refill_mint'] = {
				['name'] = "Mint Vape Juice",
				['price_to_customer'] = 25,
				['price_to_customer_min'] = 12,
				['price_to_customer_max'] = 50,
				['price_to_export'] = 22,
				...
				['amount_to_owner'] = 20,
				['amount_to_delivery'] = 20,
				['img'] = 'vape_refill_mint.png',
			},
			['vape_refill_mango'] = {
				['name'] = "Mango Vape Juice",
				['price_to_customer'] = 25,
				['price_to_customer_min'] = 12,
				['price_to_customer_max'] = 50,
				['price_to_export'] = 22,
				...
				['amount_to_owner'] = 20,
				['amount_to_delivery'] = 20,
				['img'] = 'vape_refill_mango.png',
			},
			['vape_refill_apple'] = {
				['name'] = "Apple Vape Juice",
				['price_to_customer'] = 25,
				['price_to_customer_min'] = 12,
				['price_to_customer_max'] = 50,
				['price_to_export'] = 22,
				...
				['amount_to_owner'] = 20,
				['amount_to_delivery'] = 20,
				['img'] = 'vape_refill_apple.png',
			},
			['vape_refill_pineapple'] = {
				['name'] = "Pineapple Vape Juice",
				['price_to_customer'] = 25,
				['price_to_customer_min'] = 12,
				['price_to_customer_max'] = 50,
				['price_to_export'] = 22,
				...
				['amount_to_owner'] = 20,
				['amount_to_delivery'] = 20,
				['img'] = 'vape_refill_pineapple.png',
			},
			['vape_refill_lavaflow'] = {
				['name'] = "Lava Flow Vape Juice",
				['price_to_customer'] = 25,
				['price_to_customer_min'] = 12,
				['price_to_customer_max'] = 50,
				['price_to_export'] = 22,
				...
				['amount_to_owner'] = 20,
				['amount_to_delivery'] = 20,
				['img'] = 'vape_refill_lavaflow.png',
			},
			['vape_refill_allmelon'] = {
				['name'] = "All Melon Vape Juice",
				['price_to_customer'] = 25,
				['price_to_customer_min'] = 12,
				['price_to_customer_max'] = 50,
				['price_to_export'] = 22,
				...
				['amount_to_owner'] = 20,
				['amount_to_delivery'] = 20,
				['img'] = 'vape_refill_allmelon.png',
			},
			['vape_refill_lemon'] = {
				['name'] = "Lemon Vape Juice",
				['price_to_customer'] = 25,
				['price_to_customer_min'] = 12,
				['price_to_customer_max'] = 50,
				['price_to_export'] = 22,
				...
				['amount_to_owner'] = 20,
				['amount_to_delivery'] = 20,
				['img'] = 'vape_refill_lemon.png',
			},
			['vape_refill_peach'] = {
				['name'] = "Peach Vape Juice",
				['price_to_customer'] = 25,
				['price_to_customer_min'] = 12,
				['price_to_customer_max'] = 50,
				['price_to_export'] = 22,
				...
				['amount_to_owner'] = 20,
				['amount_to_delivery'] = 20,
				['img'] = 'vape_refill_peach.png',
			},
			['vape_elfbar_blueberry'] = {
				['name'] = "Elfbar Blueberry",
				['price_to_customer'] = 75,
				['price_to_customer_min'] = 37,
				['price_to_customer_max'] = 150,
				['price_to_export'] = 67,
				['price_to_owner'] = 60,
				['amount_to_owner'] = 15,
				['amount_to_delivery'] = 15,
				['img'] = 'vape_elfbar_blueberry.png',
			},
			['vape_elfbar_cola'] = {
				['name'] = "Elfbar Cola",
				['price_to_customer'] = 75,
			...
			['vape_elfbar_melon'] = {
				...
				['amount_to_owner'] = 15,
				['amount_to_delivery'] = 15,
				['img'] = 'vape_elfbar_melon.png',
			},
			['vape_elfbar_strawberry'] = {
				['name'] = "Elfbar Strawberry",
				['price_to_customer'] = 75,
				['price_to_customer_min'] = 37,
				['price_to_customer_max'] = 150,
				['price_to_export'] = 67,
				...
				['amount_to_owner'] = 15,
				['amount_to_delivery'] = 15,
				['img'] = 'vape_elfbar_strawberry.png',
			},
		}
	},
	...
	['restaurant_supplies'] = {
		...
		['items'] = {
			...
			-- Fish & Chips Restaurant Supplies
			['fish'] = {
				['name'] = "Raw Fish",
				['price_to_customer'] = 4,
				['price_to_customer_min'] = 2,
