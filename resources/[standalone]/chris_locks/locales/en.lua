...
Locales['en'] = {
    ...
    admin_select_door_ui = 'Aim at a door and left click. Right click to cancel.',
    admin_select_door_ui_double = 'Capture the first door leaf, then the second. Right click to cancel.',
    admin_select_door_fail = 'Door selection failed.',
    admin_select_door_not_registered = 'This entity is not a registered door.',
    admin_select_door_wait_second = 'First door captured. Select the second door.',
    admin_select_door_duplicate = 'That door is already selected.',
    admin_select_door_cancel = 'Door selection cancelled.',
    admin_select_custom_single_label = 'Custom door',
    admin_select_custom_double_label = 'Custom double door',
}
