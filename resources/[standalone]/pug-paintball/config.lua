...
---------- [INTAGERS] ----------
Config.MaxTDMScore = 50 -- what score does the winning team need to reach to win in the team deathmatch game mode
...
Config.SetUnlimitedSprint = false -- Make this false if you want to remove the unlimited sprint feature.
Config.GiveFullHealthOnkill = false -- Make this false if you do not want the players health to be reset upon getting a kill.
...
Config.RequirePlayersOnBothTeams = true -- true requires there to be at least 1 player on each team to start
